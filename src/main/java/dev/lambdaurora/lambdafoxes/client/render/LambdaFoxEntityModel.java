...
package dev.lambdaurora.lambdafoxes.client.render;

import dev.lambdaurora.lambdafoxes.entity.PettableEntity;
...
public class LambdaFoxEntityModel<T extends FoxEntity> extends FoxEntityModel<T> implements PettableEntityModel {
    ...
    public static TexturedModelData getFoxModelData(Dilation extra) {
        ...
        var head = root.addChild("head", ModelPartBuilder.create().uv(1, 5)
        ...
        var dilation = extra.add(0.001f);
        var leftLeg = ModelPartBuilder.create()
                .uv(4, 24)
                .cuboid(2.f, 0.5f, -1.f, 2.f, 6.f, 2.f, dilation);
        var rightLeg = ModelPartBuilder.create()
                .uv(13, 24)
                .cuboid(2.f, 0.5f, -1.f, 2.f, 6.f, 2.f, dilation);
        root.addChild("right_hind_leg", rightLeg, ModelTransform.pivot(-5.f, 17.5f, 7.f));
        root.addChild("left_hind_leg", leftLeg, ModelTransform.pivot(-1.f, 17.5f, 7.f));
        root.addChild("right_front_leg", rightLeg, ModelTransform.pivot(-5.f, 17.5f, 0));
        root.addChild("left_front_leg", leftLeg, ModelTransform.pivot(-1.f, 17.5f, 0));
        var tail = body.addChild("tail", ModelPartBuilder.create()
                        .uv(30, 0),
