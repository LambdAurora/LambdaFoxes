...
import dev.lambdaurora.lambdafoxes.entity.TrustEntity;
...
public class FollowTrustedOwnerGoal extends Goal {
    ...
    private boolean canTeleportTo(BlockPos pos) {
        var pathNodeType = LandPathNodeMaker.getLandNodeType(this.world, pos.mutableCopy());
        if (pathNodeType != PathNodeType.WALKABLE)
            ...
            if (!this.leavesAllowed && blockState.getBlock() instanceof LeavesBlock)
                ...
                var blockPos = pos.subtract(this.entity.getBlockPos());
